...
export default function AddCustomLogoRequestModal({ open, onClose, onSubmit }) {
  ...
  return (
    <Modal
      ...
      footer={
        <button
          type="submit"
          form="add-custom-logo-request-form"
    ...
    >
      <form id="add-custom-logo-request-form" onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 gap-x-10 gap-y-5 md:grid-cols-2">
          <div className="space-y-4">
            <TextInput
              label="Ordered By:"
              id="add-custom-logo-ordered-by"
            ...
            <TextInput
              ...
              id="add-custom-logo-preferences"
              value={values.additionalPreferences}
              onChange={set('additionalPreferences')}
            />
            <Field label="Meeting Conducted:" htmlFor="add-custom-logo-meeting-date">
              <div className="grid grid-cols-2 gap-3">
                <input
                  id="add-custom-logo-meeting-date"
                  type="date"
                ...
                />
                <input
                  id="add-custom-logo-meeting-time"
                  type="time"
          ...
          <div className="space-y-4">
            ...
            <SelectInput
              label="Status:"
              id="add-custom-logo-payment-status"
            ...
            <TextInput
              ...
              id="add-custom-logo-date-delivered"
              type="date"
