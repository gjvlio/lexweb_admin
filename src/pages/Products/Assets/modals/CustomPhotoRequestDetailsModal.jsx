...
const toFormValues = (request) => ({
  ...
  photoType: request?.photoType || 'Banner',
  colors: request?.colors || ['#FFFFFF'],
  photoSubject: request?.photoSubject || '',
...
export default function CustomPhotoRequestDetailsModal({ open, request, onClose, onDelete }) {
    ...
    >
      <div className="grid grid-cols-1 gap-x-10 gap-y-5 md:grid-cols-2">
        ...
        <div className="space-y-4">
          ...
          <TextInput
            label="Photo Subject:"
            id="custom-photo-subject"
            value={values.photoSubject}
            onChange={set('photoSubject')}
          />
          <TextArea
            label="Description:"
            id="custom-photo-description"
            rows={2}
          ...
          <TextInput
            ...
            id="custom-photo-preferences"
            value={values.additionalPreferences}
            onChange={set('additionalPreferences')}
          />

          <Field label="Meeting Conducted:" htmlFor="custom-photo-meeting-date">
            <div className="grid grid-cols-2 gap-3">
              <input
                id="custom-photo-meeting-date"
                type="date"
        ...
        <div className="space-y-4">
          <Field label="Order Output:">
            <div className="aspect-[4/3] w-full overflow-hidden rounded-xl border border-slate-300 bg-white p-2">
              <div className="h-full w-full overflow-hidden rounded-lg bg-slate-100 shadow-sm">
          ...
          <TextInput
            ...
            id="custom-photo-date-delivered"
